...
SabMsg SablotMessages[] = 
{
    ...
    {ET_DUPLICATE_RULE_NAME, "duplicit rule name '%s'"}, 
    {ET_DUPLICATE_ASET_NAME, "duplicit attribute set name '%s'"}, 
    {E1_NONEX_ASET_NAME, "nonexistent attribute set name '%s'"}, 
    {E1_CIRCULAR_ASET_REF, "circular reference to attribute set '%s'"}, 
    {E1_DUPLICIT_KEY, "duplicit key '%s'"},
    ...
    {E1_FORMAT_DUPLICIT_NAME, "duplicit decimal-format name '%s'"},
    ...
    {E1_DUPLICATE_ARG, "duplicit argument '%s'"},
    ...
    {E_DUPLICIT_ATTRIBUTE, "duplicit attribute '%s'"},
    {E_DUPLICIT_OUTDOC, "duplicit output document uri '%s'"},
