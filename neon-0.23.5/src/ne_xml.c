...
/* pick up the version string. */
#if defined(HAVE_XMLVERSION_H)
#include <xmlversion.h>
#elif defined(HAVE_LIBXML_XMLVERSION_H)
#include <libxml/xmlversion.h>
#endif

#if defined(HAVE_PARSER_H)
# include <parser.h>
#elif defined(HAVE_LIBXML_PARSER_H)
# include <libxml/parser.h>
#else
#error no libxml header known!
#endif
...
/* define this for expat, libxml 2.x. libxml 1.x is not good at UTF-8
 * stuff. */
#if !defined (HAVE_LIBXML) || defined(LIBXML_VERSION_STRING)
