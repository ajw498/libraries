 ...
 * written by DefMod (Dec 12 2000) on Tue Dec 12 20:08:58 2000
...
struct plugin_message_notify
   {  bits flags;
      ...
      os_string_value url;
      bits reason;
      plugin_notify_reason notify_data;
   };
...
#define plugin_STREAM_NEW_TYPE                  ((plug_stream_new_flags) 0xFu)
...
#define plugin_STREAM_NEW_SEEKABLE              ((plug_stream_new_flags) 0x10u)
#define plugin_STREAM_WRITE_DATA_TYPE           ((plug_stream_write_flags) 0xFu)
